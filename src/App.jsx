        ...
        >
          <div className="flex flex-col md:flex-row justify-center mb-4">
            <input
              ...
              name="member[email]"
              id="member_email"
              className="text-2xl placeholder:text-white-400 placeholder:italic py-4 px-6 md:px-10 lg:py-6 lg:px-12 bg-black bg-opacity-10 focus:bg-opacity-20 duration-150 md:rounded-tr-none md:rounded-br-none rounded-full outline-none mb-4 md:mb-0"
            />
            <input
              type="submit"
              value="Join Today"
